...
from .memory.spatiotemporal_memory import SpatiotemporalMemory
...
class _QWen3_VL_luxi_Interface(nn.Module):
    """
    ...
    def __init__(self, config: Optional[dict] = None, **kwargs):
        ...
        # memory模块
        self.memory = SpatiotemporalMemory(dim=self.model.config.hidden_size, num_slots=64, num_heads=8)
...
if __name__ == "__main__":
    ...
    qwen_vl = _QWen3_VL_luxi_Interface(cfg)
    pass
